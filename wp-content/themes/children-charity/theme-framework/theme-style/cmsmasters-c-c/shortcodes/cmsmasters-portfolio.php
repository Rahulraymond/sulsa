...
$more_text = ($more_text != '') ? $more_text : esc_html__('Load More Profiles', 'children-charity');

$filter_text = ($filter_text != '') ? $filter_text : esc_html__('Filter', 'children-charity');

$filter_cats_text = ($filter_cats_text != '') ? $filter_cats_text : esc_html__('All Categories', 'children-charity');

$sorting_name_text = ($sorting_name_text != '') ? $sorting_name_text : esc_html__('Name', 'children-charity');

$sorting_date_text = ($sorting_date_text != '') ? $sorting_date_text : esc_html__('Date', 'children-charity');
