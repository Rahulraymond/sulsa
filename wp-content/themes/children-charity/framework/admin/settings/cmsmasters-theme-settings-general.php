...
function children_charity_options_general_fields($set_tab = false) {
	...
	case 'content':
		...
		$options[] = array( 
			...
			'title' => esc_html__('Heading Color Scheme by Default', 'children-charity'), 
			'desc' => '', 
			'type' => 'select_scheme', 
		...
		$options[] = array( 
			...
			'title' => esc_html__('Bottom Color Scheme', 'children-charity'), 
			'desc' => '', 
			'type' => 'select_scheme', 
	...
	case 'footer':
		$options[] = array( 
			...
			'title' => esc_html__('Footer Color Scheme', 'children-charity'), 
			'desc' => '', 
			'type' => 'select_scheme', 
