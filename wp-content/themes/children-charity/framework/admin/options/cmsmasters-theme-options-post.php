...
if (!function_exists('children_charity_get_custom_post_meta_fields')) {
function children_charity_get_custom_post_meta_fields() {
	$cmsmasters_option = children_charity_get_global_options();
	
	
	$cmsmasters_global_blog_post_layout = (isset($cmsmasters_option['children-charity' . '_blog_post_layout']) && $cmsmasters_option['children-charity' . '_blog_post_layout'] !== '') ? $cmsmasters_option['children-charity' . '_blog_post_layout'] : 'r_sidebar';
	...
	$cmsmasters_global_blog_post_title = (isset($cmsmasters_option['children-charity' . '_blog_post_title']) && $cmsmasters_option['children-charity' . '_blog_post_title'] !== '') ? (($cmsmasters_option['children-charity' . '_blog_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_share_box = (isset($cmsmasters_option['children-charity' . '_blog_post_share_box']) && $cmsmasters_option['children-charity' . '_blog_post_share_box'] !== '') ? (($cmsmasters_option['children-charity' . '_blog_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_post_author_box = (isset($cmsmasters_option['children-charity' . '_blog_post_author_box']) && $cmsmasters_option['children-charity' . '_blog_post_author_box'] !== '') ? (($cmsmasters_option['children-charity' . '_blog_post_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_blog_more_posts_box = (isset($cmsmasters_option['children-charity' . '_blog_more_posts_box'])) ? $cmsmasters_option['children-charity' . '_blog_more_posts_box'] : 'related';
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'children-charity'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'children-charity'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'children-charity'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'children-charity'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'children-charity'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'children-charity'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'children-charity'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'children-charity'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'children-charity') 
		), 
		array( 
			'id'	=> 'cmsmasters_post', 
			'type'	=> 'tab_finish' 
