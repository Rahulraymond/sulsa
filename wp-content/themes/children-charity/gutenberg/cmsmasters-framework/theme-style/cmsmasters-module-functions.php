...
function children_charity_gutenberg_editor_custom_class( $classes ) {
	...
	if (
		...
		$cmsmasters_layout = ( get_post_meta( get_the_ID(), 'cmsmasters_layout', true ) == '' ) ? $cmsmasters_option['children-charity' . '_blog_post_layout'] : get_post_meta( get_the_ID(), 'cmsmasters_layout', true );
	}
...
add_filter('admin_body_class', 'children_charity_gutenberg_editor_custom_class');
